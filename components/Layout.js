...
export default function Layout({ children }) {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span class="ml-3 text-xl">Clothing!</span>
    </a>
    <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      {/* <Link href="/first" class="mr-5 hover:text-gray-900">First Link</Link> */}
      <Link href="/first">
      <button type="button" class="text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Apparel
      </button>
      </Link>

      {/* <Link href="/second" class="mr-5 hover:text-gray-900">Second Link</Link> */}
      <Link href="/second">
      <button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Wardrobe</button>
      </Link>
      {/* <Link href="/third" class="mr-5 hover:text-gray-900">Third Link</Link> */}
      <Link href="/third">
      <button type="button" class="text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Garment</button>
      </Link>
      {/* <Link href="/forth" class="mr-5 hover:text-gray-900">Forth Link</Link> */}
    <Link href="/forth">
      <button type="button" class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Sustainability
      </button>
      </Link>
    </nav>
    <Link href="/">
    <button type="button" class="text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Home!</button>
  ...
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024-2025 <a href="#" class="hover:underline">Clothing™</a>. All Rights Reserved.</span>
  </div>
</footer>
</Link>
    </div>
